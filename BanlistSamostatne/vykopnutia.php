...
$sql = "SELECT * FROM litebans_kicks ORDER BY id DESC";
...
$sql = "SELECT * FROM litebans_kicks ORDER BY id DESC LIMIT ".$offset.",". $pocet_na_stranu;
$result = $conn->query($sql);
...
echo "<h1 style='text-align:center;'>Vykopnutia</h1><br>";
...
echo '<a href="https://midascraft.sk/upozornenia/" class="pravidla">UPOZORNENIA</a>';
echo '</div>';
echo "<br><p style='text-align:center;'>Celkový počet vykopnutí: ";
echo "<h2 style='text-align:center; font-weight:bold;'><i class='fas fa-sign-out-alt'></i> ". $celkovo_bany . "</h2></p>";
echo '<br>
...
if (isset($_GET['nick'])) {
	...
	{
	echo "<br><h3 style='text-align:center; color:red;'>Hráč s nickom " . $nickname . " ešte nebol vykopnutý!</h3>";
	}
	$conn->close();
